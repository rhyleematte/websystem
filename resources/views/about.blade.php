...
@section('title', 'About AskDocPH | Mental Health Support Platform')
...
<div class="about-page">
  ...
  <section class="about-hero">
    ...
    <div class="hero-actions">
      <a href="{{ route('signup') }}" class="btn-hero-primary">Get Started Free</a>
  ...
  <section class="cta-section">
    ...
    <div class="cta-actions">
      <a href="{{ route('signup') }}" class="btn-cta-primary">Create Free Account</a>
      <a href="{{ route('login') }}" class="btn-cta-ghost">I Already Have an Account</a>
    </div>
  </section>
  ...
  <div class="about-footer-note">
    ...
    <a href="{{ route('login') }}">Login</a> &nbsp;·&nbsp; <a href="{{ route('signup') }}">Sign Up</a> &nbsp;·&nbsp; <a href="{{ route('doctor.apply') }}">Apply as Doctor</a>
  </div>
