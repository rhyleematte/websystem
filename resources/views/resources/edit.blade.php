  ...
  <div class="composer-wrap">
    <div class="composer-card">
      ...
      <div class="composer-header">
        ...
        <a href="{{ route('resources.show', $resource->id) }}" class="composer-discard" title="Cancel">
      ...
      <form action="{{ route('resources.update', $resource->id) }}" method="POST" enctype="multipart/form-data" id="resourceForm" accept-charset="utf-8">
        ...
        <div class="composer-meta">
          ...
          <div class="composer-field">
            ...
            <input type="text" name="title" class="composer-field-input" required maxlength="50"
                   value="{{ $resource->title }}" placeholder="Resource title (max 50 chars)">
          </div>
          ...
          <div class="composer-field-row">
            <div class="composer-field">
              ...
              <select name="type" id="resTypeSelect" class="composer-field-select" required>
                ...
                <option value="Workbook" {{ $resource->type === 'Workbook' ? 'selected' : '' }}>📓 Workbook</option>
                <option value="Media" {{ $resource->type === 'Media' ? 'selected' : '' }}>🖼️ Media</option>
            ...
            <div class="composer-field">
              ...
              <input type="text" name="duration_meta" class="composer-field-input"
                     value="{{ $resource->duration_meta }}" placeholder="e.g. 5 min read">
            </div>
          </div>
          ...
          <div class="composer-field">
            ...
            <input type="text" name="description" class="composer-field-input" required
                   value="{{ $resource->description }}" placeholder="Short description shown on the card...">
          </div>
          ...
          <div class="composer-field">
            ...
            <input type="text" name="hashtags" class="composer-field-input"
                   value="{{ $resource->hashtags }}" placeholder="anxiety, coping, stress (comma separated)">
          </div>
        </div>
        ...
        <div class="existing-file-badge" style="display:flex;align-items:center;gap:10px;">
          ...
          <span>Current file: <strong>{{ strtoupper($resource->file_type) }}</strong> attached — upload a new one below to replace it.</span>
        ...
        @if($resource->thumbnail)
          <img id="thumbPreview" src="{{ $resource->thumbnail_url }}" style="display:block; max-height:80px; border-radius:8px; border:1px solid var(--border); margin:8px 20px; object-fit:cover;">
        @else
        ...
        <div class="composer-body">
          ...
          @endphp
          <div id="quill-editor">{!! $safeContent !!}</div>
        </div>
...
const initialContent = {!! json_encode($resource->content) !!};
