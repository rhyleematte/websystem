                ...
                @foreach($specialties as $index => $s)
                    ...
                    <div class="progress-wrap">
                        <div class="data-row">
                            ...
                            <span class="data-value" style="color: transparent; background: {{ $bg }}; -webkit-background-clip: text;">{{ $s->count }}</span>
                        </div>
                ...
                @foreach($genderData as $g)
                    ...
                    <div class="progress-wrap">
                        <div class="data-row">
                            ...
                            <span class="data-value">{{ $g['count'] }} <span style="font-size: 0.8rem; color: rgba(255,255,255,0.5); font-weight: 600;">APPLICANTS</span></span>
                        </div>
                        <div class="progress-bar-container">
                            <div class="progress-bar" style="width: {{ $percent }}%; background: {{ $bg }};"></div>
                        </div>
