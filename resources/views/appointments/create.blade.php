...
@section('title', 'Create New Appointment | AskDocPH')
            ...
            <div class="create-body">
                ...
                <div class="create-main">
                    ...
                    <div class="visual-placeholder-ios" onclick="document.getElementById('aptCoverInput').click()">
                        <img id="aptCoverPreview" src="{{ asset('assets/img/appointment_default.jpg') }}" alt="Default Placeholder" class="ios-visual-img">
