...
@section('title', 'Create Support Group – AskDocPH')
  ...
  <div class="dash-body">
    ...
    <main class="groups-main">
        <div style="margin-bottom: 24px;">
            <a href="{{ route('groups.index') }}" class="chip-btn" style="display: inline-flex; align-items: center; gap: 8px; background: var(--panel); border: 1px solid var(--border); padding: 10px 18px; border-radius: 12px; color: var(--text); font-weight: 600; text-decoration: none; transition: all 0.2s;">
            ...
            <div class="creation-body">
                <form action="{{ route('groups.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div style="display: flex; justify-content: flex-end; gap: 16px; padding-top: 32px; border-top: 1px solid var(--border);">
                        <a href="{{ route('groups.index') }}" class="btn secondary" style="padding:14px 28px; border-radius:14px; font-weight:700; background:var(--hover); color:var(--text); border:1px solid var(--border); text-decoration:none; display:inline-flex; align-items:center;">Cancel</a>
