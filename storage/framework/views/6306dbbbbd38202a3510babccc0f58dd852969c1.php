            ...
            <table>
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $titles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td><span class="title-badge"><?php echo e($title->name); ?></span></td>
                            <td style="color: rgba(255,255,255,0.6);"><?php echo e($title->created_at->format('M d, Y')); ?></td>
                            <td>
                                <div style="display:flex; gap:10px; justify-content: flex-end;">
                                    <button type="button" class="btn-action edit" onclick="openEditModal(<?php echo e($title->id); ?>, '<?php echo e(addslashes($title->name)); ?>')">
                                        <i data-lucide="edit-2" style="width:14px;"></i> Edit
                                    </button>
                                    <form action="<?php echo e(route('admin.professional-titles.destroy', $title->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this title?');" style="margin:0;">
                                        <?php echo csrf_field(); ?>
