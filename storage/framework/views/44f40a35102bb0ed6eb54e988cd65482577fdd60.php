<?php $__env->startSection('title', 'Forgot Password | AskDocPH'); ?>
...
<main class="wrap">
  <section class="left">
    <div class="card">
      ...
      <form method="POST" action="<?php echo e(route('password.email')); ?>" class="form" novalidate>
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
  ...
  <section class="right" style="display: flex; flex-direction: column;">
    ...
    <div style="margin-top: auto; text-align: center; padding-top: 32px;">
        <a href="<?php echo e(route('home')); ?>" style="color: rgba(255,255,255,0.7); text-decoration: none; font-size:13px; display:inline-flex; align-items:center; gap:5px; transition: color 0.2s;" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.7)'">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websystem\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>