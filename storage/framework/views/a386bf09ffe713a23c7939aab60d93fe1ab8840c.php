...
<?php $__env->startSection('title', 'Create Resource – AskDocPH'); ?>
  ...
  <div class="composer-wrap">
    <div class="composer-card">
      ...
      <div class="composer-header">
        ...
        <a href="<?php echo e(route('resources.index')); ?>" class="composer-discard" title="Discard">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
        </a>
      </div>

      
      <form action="<?php echo e(route('resources.store')); ?>" method="POST" enctype="multipart/form-data" id="resourceForm" accept-charset="utf-8">
        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\websystem\resources\views/resources/create.blade.php ENDPATH**/ ?>