<div class="panel mini-panel" id="doctorStatusPanel">
    ...
    <div style="display: flex; flex-direction: column; gap: 10px; margin-top: 10px;">
        <label style="display: flex; align-items: center; justify-content: space-between; cursor: pointer;">
            ...
            <input type="checkbox" id="doctorOnlineToggle" <?php echo e(Auth::user()->is_online ? 'checked' : ''); ?> style="accent-color: var(--primary);">
        </label>
        <label style="display: flex; align-items: center; justify-content: space-between; cursor: pointer;">
            <span style="font-size: 14px; color: var(--text-2);">Free for Get Help</span>
            <input type="checkbox" id="doctorFreeToggle" <?php echo e(Auth::user()->is_free_to_talk ? 'checked' : ''); ?> style="accent-color: var(--danger);">
        </label>
    </div>
</div>
...
<?php /**PATH C:\websystem\resources\views/partials/doctor_status_panel.blade.php ENDPATH**/ ?>