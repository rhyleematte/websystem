  ...
  <div class="res-body">
    ...
    <main class="res-main">
      ...
      <div class="res-grid">
        ...
        <div class="res-card"
             data-type="<?php echo e($res->type); ?>"
             data-title="<?php echo e(strtolower($res->title ?? '')); ?>"
             data-desc="<?php echo e(strtolower($res->description ?? '')); ?>"
             data-tags="<?php echo e(strtolower($res->hashtags ?? '')); ?>">
