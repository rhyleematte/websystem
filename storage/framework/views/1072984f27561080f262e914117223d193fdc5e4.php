...
<div class="panel" style="padding: 40px; text-align: center;">
    ...
    <div style="background: var(--panel); border: 1px solid var(--border); border-radius: 12px; padding: 20px; text-align: left; margin-top: 30px;">
        ...
        <form method="POST" action="<?php echo e(route('profile.updateAiRecommendation')); ?>" style="display: flex; align-items: center;">
            <?php echo csrf_field(); ?>
            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                <input type="checkbox" name="allow_ai_recommendation" <?php echo e($me->allow_ai_recommendation ? 'checked' : ''); ?> onchange="this.form.submit()" style="width: 18px; height: 18px; accent-color: var(--brand, #7c3aed);">
