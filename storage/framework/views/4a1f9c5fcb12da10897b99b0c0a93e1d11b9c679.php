    ...
    <div class="res-body">
        <aside class="res-sidebar">
            ...
            <?php if(request('from') === 'profile' && request('profile_id')): ?>
                <a href="<?php echo e(route('profile.show', request('profile_id'))); ?>?tab=resources" class="nav-item active" style="margin-bottom:16px; font-weight:500;">
                    <i data-lucide="arrow-left"></i><span>Back to My Profile</span>
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('resources.index')); ?>" class="nav-item active" style="margin-bottom:16px; font-weight:500;">
            ...
            <div class="panel mini-panel" style="margin-top: 16px; border-color: var(--border);">
                ...
                <div style="display: flex; flex-direction: column; gap: 8px; margin-top: 12px;">
                    <a href="<?php echo e(route('resources.edit', $resource->id)); ?>" class="chip-btn" style="width: 100%; justify-content: center; background: var(--hover); border-color: var(--border);">
                        <i data-lucide="edit-3"></i> Edit Resource
                    </a>
                    
                    <form action="<?php echo e(route('resources.destroy', $resource->id)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this resource?');">
                        <?php echo csrf_field(); ?>
